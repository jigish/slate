...
NSString *const WINDOW_HINTS_ORDER_DEFAULT = @"persist";
...
NSString *const SWITCH_SECONDS_BEFORE_REPEAT_DEFAULT = @"0.4";
NSString *const SWITCH_SECONDS_BETWEEN_REPEAT = @"switchSecondsBetweenRepeat";
NSString *const SWITCH_SECONDS_BETWEEN_REPEAT_DEFAULT = @"0.05";
